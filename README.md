...
![alt_text](https://github.com/nandanlahurikar/U--Extended-Kalman-Filter/blob/master/P&U.png?raw=true)
...
Rduces RMSE values for X,Y VX and VY by chnaging maesument covarience matrix for both lidar and radar.
